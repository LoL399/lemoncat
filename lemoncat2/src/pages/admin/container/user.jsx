...
class UserDetail extends Component {
  state = { viewDetails: true, id:"",  name:"", email: "", password:"",photo:"", role:"" }
    ...
    render() { 
        return ( <form>
          <fieldset disabled={this.state.viewDetails}>
            ...
            {this.state.viewDetails===true?<a className="btn btn-warning text-light" onClick={()=>this.toEdit()}>Edit</a>:<a className="btn btn-primary text-light" onClick={()=>this.createUser()}>Add</a>}
